...
export default function CommissionsPage() {
  ...
  const downloadCSV = () => {
    ...
    a.href = url;
    a.download = `commissions-${dateFilter}-${new Date().toISOString().split('T')[0]}.csv`;
      ...
      <div className="p-8 space-y-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-serif font-bold text-primary">Commissions</h1>
            <p className="text-muted-foreground mt-1">Track your earnings from bookings.</p>
          </div>
        </div>
