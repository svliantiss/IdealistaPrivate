      ...
      <div className="p-8 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">Your currently active rental properties.</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          {activeProperties.length === 0 && (
            <Card className="p-12 text-center">
              ...
              <h3 className="font-serif text-xl font-bold mb-2">No active listings</h3>
              <p className="text-muted-foreground mb-6">You don't have any active listings at the moment.</p>
